...
export const MEDIA_ASSETS: ReadonlyArray<MediaAsset> = [
  ...
  {
    id: "map-european-interconnection-corridors",
    title: "European interconnection corridors map",
    type: "topology-diagram",
    status: "verified",
    source: {
      name: "Self-authored",
      pageUrl:
        "https://radar.webmasterid.com/visuals/map-european-interconnection-corridors",
    },
    license: {
      name: "CC BY 4.0",
      url: "https://creativecommons.org/licenses/by/4.0/",
    ...
    author: "Radar WebmasterID editorial",
    altText:
      "Editorial topology map showing the FLAP cluster (Frankfurt, London, Amsterdam, Paris) with secondary corridors to Madrid and Milan. Node positions are abstract, not geographic; corridors represent topology, not exact fibre routing.",
    caption:
      "The FLAP cluster as an editorial topology triangle, with secondary corridors out to Southern Europe and the Iberian peninsula.",
    relatedEntityRefs: [
      "city:frankfurt",
      "city:london",
      "city:amsterdam",
    ...
    category: "geography",
    geographicCoverage: "Europe — FLAP cluster + secondary corridors",
    inlineComponent: "EuropeanInterconnectionCorridorMap",
    dimensions: { width: 720, height: 460 },
    lastVerified: REVIEWED_AT_3,
  },
  {
    id: "map-transatlantic-connectivity-corridors",
    title: "Transatlantic connectivity corridors map",
    type: "topology-diagram",
    status: "verified",
    source: {
      name: "Self-authored",
      pageUrl:
        "https://radar.webmasterid.com/visuals/map-transatlantic-connectivity-corridors",
    },
    license: {
      name: "CC BY 4.0",
      url: "https://creativecommons.org/licenses/by/4.0/",
    ...
    author: "Radar WebmasterID editorial",
    altText:
      "Editorial topology map showing the US east-coast landing-to-inland-metro flow (Virginia Beach and New York to Ashburn) and the UK / EU landing-to-inland-metro flow (Bude and Bilbao to London, Paris, and Frankfurt), with curved subsea corridors connecting them. The curves are conceptual — the platform does not draw exact cable polylines.",
    caption:
      "Transatlantic cable corridors abstracted as curves between coastal landing areas; inland backhaul is shown explicitly.",
    relatedEntityRefs: [
      "city:ashburn",
      "city:london",
      "city:frankfurt",
    ...
    category: "subsea",
    geographicCoverage: "North Atlantic corridor",
    inlineComponent: "TransatlanticConnectivityCorridorMap",
    dimensions: { width: 720, height: 460 },
    lastVerified: REVIEWED_AT_3,
  },
  {
    id: "map-ai-cloud-geography",
    title: "AI-capable cloud geography map",
    type: "topology-diagram",
    status: "verified",
    source: {
      name: "Self-authored",
      pageUrl: "https://radar.webmasterid.com/visuals/map-ai-cloud-geography",
    },
    license: {
      name: "CC BY 4.0",
      url: "https://creativecommons.org/licenses/by/4.0/",
    ...
    author: "Radar WebmasterID editorial",
    altText:
      "Editorial topology map showing the five metros where managed-AI services from AWS Bedrock, Azure OpenAI, and Vertex AI are officially documented as available: Ashburn, London, Frankfurt, Singapore, and Tokyo. Each metro is annotated with the providers that document availability there; the map does not depict per-model availability, GPU counts, or accelerator inventory.",
    caption:
      "Managed-AI service geography clusters in the same five metros as the three-hyperscaler general-availability footprint.",
    relatedEntityRefs: [
      "city:ashburn",
      "city:london",
      "city:frankfurt",
    ...
    category: "cloud",
    geographicCoverage: "Five-metro three-hyperscaler AI cluster",
    inlineComponent: "AICloudGeographyMap",
    dimensions: { width: 720, height: 460 },
    lastVerified: REVIEWED_AT_3,
  },
  {
