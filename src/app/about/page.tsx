    ...
    <Container as="article">
      ...
      <div className="mt-12 grid gap-12 md:grid-cols-3">
        <section className="md:col-span-2 max-w-prose">
          <h2 className="text-xl font-semibold text-graphite-50">Mission</h2>
          ...
          <h2 className="mt-10 text-xl font-semibold text-graphite-50">
            Editorial position
          </h2>
          <p className="mt-3 text-graphite-300">
          ...
          <h2 className="mt-10 text-xl font-semibold text-graphite-50">Scope</h2>
          <p className="mt-3 text-graphite-300">
        ...
        <aside className="space-y-6 text-sm">
          <section className="rounded-lg border border-graphite-800 bg-graphite-900/50 p-5">
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/sources" className="text-signal-blue-300 hover:text-signal-blue-200">
                  Source registry
                </Link>
              </li>
              <li>
                <Link href="/rankings" className="text-signal-blue-300 hover:text-signal-blue-200">
                  Rankings
                </Link>
              </li>
            </ul>
          ...
          <section className="rounded-lg border border-graphite-800 bg-graphite-900/50 p-5">
            ...
            <p className="mt-3 text-graphite-200">{SITE.organization.name}</p>
            <a
              href={SITE.organization.url}
              className="mt-1 inline-block text-graphite-400 underline decoration-graphite-700 hover:text-graphite-200"
            >
